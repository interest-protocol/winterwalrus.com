...
import { useLSTNFTsPreviewUnstake } from './use-lst-nfts-preview-unstake';

const LSTNFTsUnstakeFormButtonPreview: FC<{
  onProceed: () => void;
}> = ({ onProceed }) => {
  ...
  const { data, isLoading, error } = useLSTNFTsPreviewUnstake({
    coinIn,
...
export default LSTNFTsUnstakeFormButtonPreview;
