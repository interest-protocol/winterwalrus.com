...
import { useNativeStakedWalPreviewUnstake } from './use-native-staked-preview-unstake';

const NativeStakedWalUnstakeFormButtonPreview: FC<{
  onProceed: () => void;
}> = ({ onProceed }) => {
  ...
  const { data, isLoading, error } = useNativeStakedWalPreviewUnstake({
    coinIn,
...
export default NativeStakedWalUnstakeFormButtonPreview;
